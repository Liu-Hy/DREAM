...
parser.add_argument('--imagenet_dir', default='/tmp/data/IN1K/', type=str)
parser.add_argument('--tinyimagenet_dir', default='./data/tinyimagenet/', type=str)
...
parser.add_argument('--init',
                    type=str,
                    default='kmean',
                    choices=['random', 'noise', 'mix','kmean'],
                    help='condensed data initialization type')
parser.add_argument('--f2_init',
                    type=str,
                    default='kmean',
                    choices=['random', 'kmean'],
                    help='condensed data initialization type')
